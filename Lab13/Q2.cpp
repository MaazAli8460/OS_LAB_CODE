...
void *process(void *arg)
{
    ...
    while (true)
    {
        pthread_mutex_lock(&input_mutex); // Lock the input_mutex to ensure exclusive access to input
        cout << "\nUser " << index << ": Press 1 to read file, press 2 to write to file, press 3 to quit writing mode, press 4 to quit: ";
        cin >> choice;
        pthread_mutex_unlock(&input_mutex); // Unlock input_mutex after reading input
